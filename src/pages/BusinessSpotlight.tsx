...
export function BusinessSpotlight() {
  ...
  return (
    <div className="bg-paper-cream">
      ...
      {/* Content Section */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="bg-rogue-green text-paper-cream p-8 sketchy-border space-y-8 sticky top-32">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href={business.contactDetails.website} className="text-sm opacity-80 hover:text-rogue-accent transition-colors underline underline-offset-4">Visit Website</a>
              </div>
            </div>
